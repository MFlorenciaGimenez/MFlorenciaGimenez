...
![RAG](https://img.shields.io/badge/RAG-8A2BE2?logo=openaigym&logoColor=white)
---

## 🌱 About Me
- Jr Full Stack Developer with a strong interest in **Backend architecture** and real-world problem solving.
- I work mainly with **TypeScript, NestJS, React/Next.js, and PostgreSQL**, and recently started integrating **Python + RAG** into my projects.
- Graduated from the intensive Henry Bootcamp — building both individual and collaborative full-stack applications.
- Passionate about continuous learning, clean code, and scalable app design.
- Strong foundation in **logical reasoning and problem-solving** from my Engineering studies (UNLP).
- Spanish native speaker — English level: **C2 Proficient (EF SET Certificate)**.

### 🌐 Portfolio
 **[https://tupagina.com](https://mflorencia.vercel.app/)**  
